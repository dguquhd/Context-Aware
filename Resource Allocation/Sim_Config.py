# set the key parameters for the D-Decision scheme with Real Feedback
...
class RL_Config:
    ...
    def __init__(self):
        ...
        self.Num_Run_Episodes = 100  # number of episodes for testing
        self.Num_Test_Steps = 100  # number of step in each testing Episode
